...
## **Data source**
default provider uses a free market-data suitable for daily-bar risk analysis. A production system would and will use a paid feed for better reliabilitya and market coverage
